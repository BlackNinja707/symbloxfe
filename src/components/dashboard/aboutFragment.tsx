...
const AboutFragment = () => {
  ...
  return (
    <>
      <div id="about-fragment" className="hidden lg:flex w-full py-16 px-0 justify-center items-center gap-[58px] flex-row font-Barlow">
        <div className={`${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"} transition-all duration-500 ease-in`}>
          <img src="/assets/Image/AboutBackground.png" alt="aboutBackground" />
        </div>
        <div className={`${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20"} flex flex-col items-start gap-[26px] transition-all duration-500 ease delay-300`}>
