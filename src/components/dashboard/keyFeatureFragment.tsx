...
const KeyFeatureFragment: React.FC = () => {
	...
	return (
		<div className="flex md:pt-16 pb-[120px] px-6 md:px-36 gap-6 items-start justify-center relative font-Barlow">
			<div
				id="key-feature-fragment"
				className="flex flex-col lg:grid lg:grid-cols-3 gap-6 items-start justify-center mx-auto w-full"
			>
				<div className="flex flex-col py-8 lg:py-16 items-start gap-6 flex-[1_0_0] self-stretch">
					<div
						...
						} flex flex-col w-full items-center lg:items-start lg:gap-6 relative`}
					>
						...
						<div
							...
							className={`transition-all duration-1000 delay-[${
								...
								isVisible
									? "opacity-100 translate-y-0"
									: "opacity-0 translate-y-20"
							} flex flex-col gap-2 lg:gap-4 items-start p-6 lg:p-10 h-full w-full rounded-[12px] bg-primaryBoxColor`}
						>
