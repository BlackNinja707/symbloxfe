...
const RewardFragment = () => {
	...
	return (
		<>
			<div
				id="reward-fragment"
				className="pt-20 pb-16 mx-auto w-full font-Barlow"
			>
				<div className="px-24 lg:px-36 mx-auto hidden lg:flex flex-col items-center justify-center">
					<div className="grid grid-cols-2 items-start gap-16">
						<div
							...
							} relative p-12 gap-5 h-full w-full items-start bg-primaryBoxColor rounded-[20px]`}
						>
					...
					<div
						className={`transition-all duration-500 ease-in ${
							isVisible
								? "opacity-100 translate-x-0"
								: "opacity-0 -translate-x-20"
						} relative mt-16 h-[191px] flex flex-col p-6 gap-5 items-start flex-[1_0_0] bg-primaryBoxColor rounded-[20px]`}
					>
					...
					<div
						className={`transition-all duration-500 ease-in delay-300 ${
							isVisible
								? "opacity-100 translate-x-0"
								: "opacity-0 translate-x-20"
						} relative mt-24 flex flex-col p-6 gap-5 items-start flex-[1_0_0] bg-primaryBoxColor rounded-[20px]`}
					>
						<span className="text-white mt-20 font-bold text-lg leading-[24px]">
							{t("reward.security")}
						</span>
